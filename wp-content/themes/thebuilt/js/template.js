    ...
    $(document).ready(function() {
        ...
        $(".navbar li.onepage-link-inside a.onepage-link").on('click', function(e) {
            if ($($(this).attr("href")).offset()) {
                ...
                $("html, body").animate({
                    scrollTop: $($(this).attr("href")).offset().top - header_height - $("#wpadminbar").height() + header_add_top
                }, 500);
